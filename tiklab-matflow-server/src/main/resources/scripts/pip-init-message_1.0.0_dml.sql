...
update pcs_mec_message_template set pcs_mec_message_template.content = '任务${taskName}${message}' where pcs_mec_message_template.id = '0a5e5589435e';
update pcs_mec_message_template set pcs_mec_message_template.content = '任务${taskName}${message}' where pcs_mec_message_template.id = '0acf89d30595';
update pcs_mec_message_template set pcs_mec_message_template.content = '任务${taskName}${message}' where pcs_mec_message_template.id = '31ef95545115';
update pcs_mec_message_template set pcs_mec_message_template.content = '任务<span style="color: #5d70ea">${taskName}</span>${message}' where pcs_mec_message_template.id = '7fa67bf3d03d';
