...
#
# INSERT INTO `pip_task_code` (`id`, `code_name`, `code_address`, `code_branch`, `svn_file`, `auth_id`) VALUES ('412eff299fcabd49be8742c485f4b2ae', 'git@gitee.com:tiklab/tiklab-example.git', 'git@gitee.com:tiklab/tiklab-example.git', 'master', NULL, 'f812ab93d8ffb399dc21d37e8d0e423b', '406d153ed223d1d5af88d239a1545751');
# INSERT INTO `pip_task_code` (`id`, `code_name`, `code_address`, `code_branch`, `svn_file`, `auth_id`) VALUES ('9a3a051973bdf00a03d6afbca7aee51f', 'git@gitee.com:tiklab/tiklab-example.git', 'git@gitee.com:tiklab/tiklab-example.git', 'master', NULL, 'f812ab93d8ffb399dc21d37e8d0e423b', '1acd83d0e9015dfb7852e1940bde4f3f');
#
