...
-- 消息发送类型模板
INSERT INTO `pcs_mec_message_template` VALUES ('0a5e5589435eecf85caafae4fd7d6b23', 'MES_PIPELINE_TASK_RUN', 'dingding', '运行', '${taskMessage}', '/index/pipeline/${pipelineId}/structure', 'matflow', NULL);
INSERT INTO `pcs_mec_message_template` VALUES ('0acf89d305952cf42d446d2973905d96', 'MES_PIPELINE_TASK_RUN', 'email', '运行', '${taskMessage}', '/index/pipeline/${pipelineId}/structure', 'matflow', NULL);
...
INSERT INTO `pcs_mec_message_template` VALUES ('31ef95545115a6ba9d4572264d9bddc8', 'MES_PIPELINE_TASK_RUN', 'qywechat', NULL, '${taskMessage}', '/index/pipeline/${pipelineId}/structure', 'matflow', NULL);
...
INSERT INTO `pcs_mec_message_template` VALUES ('7fa67bf3d03d3fa4debd8062054c751d', 'MES_PIPELINE_TASK_RUN', 'site', '运行', '${taskMessage}', '/index/pipeline/${pipelineId}/structure', 'matflow', NULL);
