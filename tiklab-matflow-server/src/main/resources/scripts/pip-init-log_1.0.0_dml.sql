...
update pcs_op_log_template set pcs_op_log_template.link = '/index/pipeline/${pipelineId}/config'  where pcs_op_log_template.id = 'ONFIG_CREATE';
update pcs_op_log_template set pcs_op_log_template.link = '/index/pipeline/${pipelineId}/config'  where pcs_op_log_template.id = 'ONFIG_DELETE';
update pcs_op_log_template set pcs_op_log_template.link = '/index/pipeline/${pipelineId}/survey' where pcs_op_log_template.id = 'G_TEM_CREATE';
update pcs_op_log_template set pcs_op_log_template.link = '/index/pipeline/${pipelineId}/survey' where pcs_op_log_template.id = 'G_TEM_DELETE';
update pcs_op_log_template set pcs_op_log_template.link = '/index/pipeline/${pipelineId}/survey' where pcs_op_log_template.id = 'G_TEM_UPDATE';
