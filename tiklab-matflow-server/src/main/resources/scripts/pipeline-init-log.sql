...
INSERT INTO `pcs_op_log_template` (`id`, `title`, `content`, `link`, `bgroup`) VALUES ('LOG_TEM_RUN', '流水线运行', '流水线<span style=\"color: #5d70ea\">${pipelineName}</span>${message}', '/index/task/${pipelineId}/structure', 'matflow');
