...
INSERT INTO `pcs_mec_message_template` (`id`, `msg_type_id`, `msg_send_type_id`, `title`, `content`, `link`, `bgroup`) VALUES ('5c32aa18973df4c45a42f60752d7710e', 'MES_PIPELINE_RUN', 'dingding', '运行', '${pipelineName}${message}', 'http://192.168.10.23:3000/#/index/task/${pipelineId}/structure', 'matflow');
