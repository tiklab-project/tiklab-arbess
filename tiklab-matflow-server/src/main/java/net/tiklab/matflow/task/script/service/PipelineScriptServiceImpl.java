...
import net.tiklab.matflow.task.script.dao.PipelineScriptDao;
import net.tiklab.matflow.task.script.entity.PipelineScriptEntity;
...
@Service
@Exporter
public class PipelineScriptServiceImpl implements PipelineScriptService {
