...
public class TaskCodeThirdServiceImpl implements TaskCodeThirdService {
    ...
    public String findCode(AuthThird authThird){
        ...
        return taskCodeThird.getCode(authThird);
    }
    ...
    public String findAccessToken(AuthThird authThird) throws IOException , ApplicationException {
        ...
        String accessTokenUrl = taskCodeThird.getAccessToken(authThird);
    ...
    public List<String> findAllStorehouse(String authId,int type) {
        ...
        String allStorehouseAddress = taskCodeThird.getAllStorehouse(accessToken,type);
    ...
    public List<String> findBranch(String authId,String houseName,int type) {
        ...
        String url = taskCodeThird.getBranch(name,house,accessToken,type);
        return switch (type) {
    ...
    public String getHouseUrl(String authCodeId,String houseName,int type){
        ...
        //获取仓库URl
        String oneStorehouse = taskCodeThird.getOneHouse(name,house,accessToken,type);
        return switch (type) {
    ...
    public String findMessage(String accessToken,int authType){
        ...
        String userMessage = taskCodeThird.getUser(accessToken,authType);
