...
import net.tiklab.matflow.task.test.dao.PipelineTestDao;
import net.tiklab.matflow.task.test.entity.PipelineTestEntity;
...
@Service
@Exporter
public class PipelineTestServiceImpl implements TestService.PipelineTestService {
