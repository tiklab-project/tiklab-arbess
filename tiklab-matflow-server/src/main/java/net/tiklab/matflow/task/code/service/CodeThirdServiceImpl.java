...
import net.tiklab.matflow.task.code.model.PipelineCodeThird;
...
public class CodeThirdServiceImpl implements CodeThirdService {
    ...
    @Autowired
    PipelineCodeThird pipelineCodeThird;

    @Autowired
    PipelineAuthThirdService serverServer;
    ...
    public String findCode(PipelineAuthThird authThird){
        ...
        return pipelineCodeThird.getCode(authThird);
    }
    ...
    public String findAccessToken(PipelineAuthThird authThird) throws IOException , ApplicationException {
        ...
        String accessTokenUrl = pipelineCodeThird.getAccessToken(authThird);
    ...
    public List<String> findAllStorehouse(String authId,int type) {
        ...
        String allStorehouseAddress = pipelineCodeThird.getAllStorehouse(accessToken,type);
    ...
    public List<String> findBranch(String authId,String houseName,int type) {
        ...
        String url = pipelineCodeThird.getBranch(name,house,accessToken,type);
        return switch (type) {
    ...
    public String getHouseUrl(String authCodeId,String houseName,int type){
        ...
        //获取仓库URl
        String oneStorehouse = pipelineCodeThird.getOneHouse(name,house,accessToken,type);
        return switch (type) {
    ...
    public String findMessage(String accessToken,int authType){
        ...
        String userMessage = pipelineCodeThird.getUser(accessToken,authType);
    ...
    public void updateAuthorization() {
        ...
        for (PipelineAuthThird authCode : allAuthCode) {
            ...
            String refreshToken = pipelineCodeThird.findRefreshToken(authCode.getRefreshToken());
