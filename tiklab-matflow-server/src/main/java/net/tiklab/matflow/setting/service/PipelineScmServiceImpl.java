...
import net.tiklab.matflow.setting.dao.PipelineScmDao;
...
@Service
public class PipelineScmServiceImpl implements net.tiklab.matflow.setting.service.PipelineScmService {
