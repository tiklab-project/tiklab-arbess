...
@Service
public class PipelineWebSocketService implements WebSocketHandler {


    @Autowired
    PipelineExecService pipelineExecService;

    private static final Logger logger = LoggerFactory.getLogger(PipelineWebSocketService.class);
