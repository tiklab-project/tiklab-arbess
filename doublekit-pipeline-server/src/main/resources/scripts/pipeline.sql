...
CREATE TABLE `pipeline_configure`  (
       ...
       `configure_code_source` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '代码源',
       ...
       `configure_code_structure` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '构建源',
...
CREATE TABLE `pipeline_history`  (
     ...
     `history_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
