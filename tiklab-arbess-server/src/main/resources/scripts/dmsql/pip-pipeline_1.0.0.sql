...
ALTER TABLE pip_task MODIFY task_type varchar(255);
ALTER TABLE pip_task_instance MODIFY task_type varchar(255);
ALTER TABLE pip_auth_host MODIFY type varchar(255);
ALTER TABLE pip_auth_server MODIFY type varchar(255);
ALTER TABLE pip_postprocess MODIFY task_type varchar(255);
