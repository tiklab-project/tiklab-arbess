...
import io.tiklab.arbess.task.build.dao.TaskBuildDao;
import io.tiklab.arbess.task.build.entity.TaskBuildEntity;
...
import static io.tiklab.arbess.support.util.util.PipelineFinal.TASK_BUILD_DOCKER;
