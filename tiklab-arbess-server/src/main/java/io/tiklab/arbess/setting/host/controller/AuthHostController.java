package io.tiklab.arbess.setting.host.controller;
...
public class AuthHostController {
    ...
    /**
     * @pi.name:创建主机认证信息
     * @pi.url:/authHost/createAuthHost
     * @pi.methodType:post
    ...
    /**
     * @pi.name:删除主机认证信息
     * @pi.url:/authHost/deleteAuthHost
     * @pi.methodType:post
    ...
    /**
     * @pi.name:更新主机认证信息
     * @pi.url:/authHost/updateAuthHost
     * @pi.methodType:post
     * @pi.request-type: json
     * @pi.param: model=authHost
     */
    ...
    /**
     * @pi.name:查询主机认证信息
     * @pi.url:/authHost/findAllAuthHostList
     * @pi.methodType:post
     * @pi.request-type:formdata
    ...
    /**
     * @pi.name:分页查询主机认证信息
     * @pi.url:/authHost/findAuthHostPage
     * @pi.methodType:post
     * @pi.request-type:json
