...
import static io.tiklab.matflow.support.util.PipelineFinal.DEFAULT_CLEAN_CACHE_DAY;
...
public class TaskCleanLogCache {
    ...
    public void scheduledBackups(){
        ...
        for (PipelineInstance instance : allInstance) {
            ...
            String dateTime = PipelineUtil.findDateTime(date, DEFAULT_CLEAN_CACHE_DAY);
