...
> 执行状态：<font color=${colour}>**${execStatus}**</font>', link = '/#/pipeline/${pipelineId}/history', bgroup = 'matflow', link_params = NULL WHERE id = '7ff3948a5c9b';
...
> 流水线名称：<font color=info>[${pipelineName}](${qywxurl})</font>', link = '/#/pipeline/${pipelineId}/history', bgroup = 'matflow', link_params = NULL WHERE id = 'ea2656a4c4bf';
UPDATE pcs_mec_message_template SET msg_type_id = 'MF_MES_TYPE_DELETE', msg_send_type_id = 'qywechat', title = NULL, content = E'## 删除流水线\n
> 执行人：<font color=comment>${userName}</font>\n
> 流水线名称：<font color=warning>[${pipelineName}](${qywxurl})</font>', link = '/#/home', bgroup = 'matflow', link_params = NULL WHERE id = 'a48b296dce37';
...
> 更新前后名称：<font color=warning>[${pipelineName}](${qywxurl})</font>', link = '/#/pipeline/${pipelineId}/history', bgroup = 'matflow', link_params = NULL WHERE id = 'bb09db8fa4d1';